...
const GooeyNav: React.FC<GooeyNavProps> = ({
  ...
  const handleClick = (e: React.MouseEvent | { currentTarget: HTMLElement }, index: number) => {
    ...
    <>
      ...
      <div className="relative" ref={containerRef}>
        <nav className="flex relative" style={{ transform: 'translate3d(0,0,0.01px)' }}>
          <ul
            ref={navRef}
            className="flex gap-4 md:gap-8 list-none p-0 px-2 m-0 relative z-[3]"
            style={{
              color: 'white',
            }}
          >
            {items.map((item, index) => (
              ...
              >
                <a
                  ...
                  className="outline-none py-[0.8em] px-[1.2em] inline-block font-clash font-extrabold text-[12px] md:text-[14px] tracking-[0.15em] uppercase hover:opacity-100 transition-opacity"
                  onClick={(e) => {
