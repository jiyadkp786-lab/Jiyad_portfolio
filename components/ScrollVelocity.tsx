...
function VelocityText({
  ...
  return (
    <div className={`${parallaxClassName} relative overflow-hidden`} style={parallaxStyle}>
      <motion.div
        className={`${scrollerClassName} flex whitespace-nowrap text-center font-sans text-4xl font-black tracking-[-0.04em] uppercase decoration-cyan-500 md:text-[8rem] md:leading-[8rem]`}
